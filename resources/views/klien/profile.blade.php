...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('klien.dashboard') }}" class="btn btn-secondary btn-sm">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('klien.profile.update') }}" method="POST">
                        ...
                        <h6 class="font-weight-bold text-primary mb-3">Ubah Password (Opsional)</h6>
                        <p class="text-muted small">Kosongkan field di bawah jika tidak ingin mengubah password</p>
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('klien.dashboard') }}" class="btn btn-secondary">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <span class="badge badge-primary badge-pill">Klien</span>
